...
const FounderCard = ({ founder }: { founder: Founder }) => (
  <div className="w-full px-4 md:w-1/2">
    <div className="mb-10 rounded-xl bg-white p-6 text-center shadow-lg dark:bg-gray-800">
      <div className="relative mx-65 mb-5 h-32 w-32">
        <Image
          src={founder.image}
          alt={founder.name}
          height={110}
      ...
      <p className="mb-3 text-body-color dark:text-gray-300">{founder.role}</p>
      <p className="text-body-color mb-3 text-sm dark:text-gray-400">
        {founder.bio}
      </p>
      <div className="flex justify-center space-x-4">
        {founder.social?.linkedin && (
          <a href={founder.social.linkedin} target="_blank" rel="noreferrer" className="text-blue-600 hover:text-blue-800">
            LinkedIn
          </a>
        )}
        {founder.social?.twitter && (
          <a href={founder.social.twitter} target="_blank" rel="noreferrer" className="text-blue-400 hover:text-blue-600">
            Twitter
          </a>
        )}
      </div>
